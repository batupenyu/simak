            ...
            <tbody>
                <tr>
                    <td >
                        ...
                        <a href="{{ url('sdm.add') }}"  ><i class="fa fa-plus-circle tampil"></i></a>
                        <br>
                        ...
                        <td >
                            ...
                            <br>
                                ...
                                @foreach ($user->skema as $item)
                                    ...
                                    <form class="d-inline tampil" action="{{ url('delete_skema/'.$item->id) }}" method="post" onclick="return confirm ('yakin hapus data?')">
                                        @csrf
                                        @method('delete')
                                        <button class="btn btn-sm btn-danger tampil" type="submit"><i class="fa fa-trash"></i></button>
                                    </form>
