            ...
            @endif
                ...
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ Session::get('name') }}" class="form-control" placeholder="name" required="">
                    </div>
                    <div class="form-group">
                    ...
                    <hr>
                    <p class="text-center mt-3">Sudah punya akun silahkan <a href="/sesi">Login Disini!</a></p>
                </form>
        </div>
    </div>
</body>
