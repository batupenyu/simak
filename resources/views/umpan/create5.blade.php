            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="row register-form">
                        <form class="form-card" action="{{ url('umpan.store5') }}" method="post">
                            @csrf
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <br>
                                <div class="form-group">
                                    <label for="umpan"><strong><u>Loyal</u></strong></label> <br>
                                    ...
                                    <textarea name="umpan5" id="" cols="80" rows="5"></textarea>
                                </div>
                            </div>
