            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="row register-form">
                        <form class="form-card" action="{{ url('umpan.store4') }}" method="post">
                            @csrf
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <br>
                                <div class="form-group">
                                    <label for="umpan"><strong><u>Harmonis</u></strong></label> <br>
                                    ...
                                    <textarea name="umpan4" id="" cols="80" rows="5"></textarea>
                                </div>
                            </div>
