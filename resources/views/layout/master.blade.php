        ...
        <li class="nav-item dropdown tampil">
          ...
          <li class="nav-item tampil">
            <div class="dropdown show">
              <a class="btn light  dropdown-toggle" href="/tabel" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Pegawai
              </a>
          ...
          <li class="nav-item tampil">
            {{-- <a class="nav-link " href="/bku.bku">BKU</a> --}}
              <div class="dropdown show">
                <a class="btn light  dropdown-toggle" href="/bku.bku" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  BKU
                </a>
