            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="row register-form">
                        <form class="form-card" action="{{ url('/ekspektasi.store2') }}" method="post">
                            @csrf
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <label for="eks2"><strong><u>Akuntabel</u></strong></label> <br>
                                    <label class="mb-3" for="eks2">
                                    ...
                                    <textarea name="eks2" id="" cols="80" rows="5" placeholder="Perilaku 2"></textarea>
                                </div>
                            </div>
