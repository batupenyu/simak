...
<div class="container-fluid mt-4">
    ...
    <div class="page-header d-flex justify-content-between align-items-center">
        <div>
            <h3 class="fw-bold mb-1"><i class="fa fa-file-invoice me-2"></i>KP-4.2 - Daftar Pegawai</h3>
            <p class="mb-0 opacity-75">Daftar Pegawai untuk Pencetakan KP-4.2 (Data Pasangan)</p>
        </div>
            ...
            <table class="table table-hover table-custom" id="pegawaiTable">
                <thead>
                    <tr>
                        ...
                        <th width="15%">Status Pasangan</th>
                        <th width="10%">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                                $jumlahPasangan = $item->pasangan ? $item->pasangan->count() : 0;
                            @endphp
                            <span class="badge bg-{{ $jumlahPasangan > 0 ? 'success' : 'secondary' }}">
                                {{ $jumlahPasangan }} Pasangan
                            </span>
                        </td>
                        <td>
                            <a href="{{ route('kp3', $item->id) }}" class="btn btn-sm btn-info btn-action" title="Lihat Detail">
                                <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('kp4newpdf', $item->id) }}" class="btn btn-sm btn-danger btn-action" title="Cetak PDF" target="_blank">
    ...
    <div class="alert alert-info mt-3">
        ...
        <strong>Informasi:</strong> KP-4.2 adalah daftar riwayat hidup pasangan pegawai. 
