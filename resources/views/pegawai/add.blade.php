                ...
                <form class="form-card" action="{{ url('/pegawai.store') }}" method="post">
                    ...
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex ">
                            ...
                            <input type="text" id="tempat_lahir" name="tempat_lahir" placeholder="Tempat lahir" onblur="validate(5)">
                        </div>
                        <div class="form-group col-sm-6 flex-column d-flex ">
                            {{-- <label class="form-control-label px-3">Tugas Tambahan<span class="text-danger"> *</span></label>  --}}
                            <input type="text" id="tugas_tambahan" name="tugas_tambahan" placeholder="Tugas Tambahan" onblur="validate(5)">
                        </div>
                    </div>
                    <div class="row justify-content-between text-left">
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex">
                            ...
                            <input type="hidden" id="email_verified_at" name="email_verified_at" placeholder="" onblur="validate(3)">
                        </div>
                        <div class="form-group col-sm-6 flex-column d-flex">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex">
                            ...
                            <input type="text" id="no_karpeg" name="no_karpeg" placeholder="No.Karpeg" onblur="validate(3)">
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex">
                            ...
                            <input type="text" id="ak_integrasi" name="ak_integrasi" placeholder="ak_integrasi" onblur="validate(7)">
                        </div>
                    </div>
                    <div class="row justify-content-between text-left">
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-4 flex-column d-flex ">
                            ...
                            <input type="text" id="nuptk" name="nuptk" placeholder="NUTPK" onblur="validate(5)">
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-12 flex-column d-flex "> <label class="form-control-label px-3">Mapel<span class="text-danger"> *</span></label>
                            @if(isset($mapel) && is_iterable($mapel))
                            ...
                            <div class="alert alert-warning" role="alert" style="margin-bottom: 10px;">
                                No mapel data available.
                            </div>
                            <select class="select2 form-control" name="mapel[]" multiple="multiple" id="select2" multiple onchange="getCount()">
                                <option disabled>No mapel data available</option>
                            </select>
                            @endif
                        </div>
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-4 flex-column d-flex ">
                                ...
                                <input type="text" id="jlh_jam" name="jlh_jam" placeholder="Jumlah jam " onblur="validate(5)">
                            </div>
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex ">
                                ...
                                <input type="text" id="kabupaten" name="kabupaten" placeholder="Kabupaten" onblur="validate(5)">
                            </div>
                            <div class="form-group col-sm-6 flex-column d-flex ">
                                {{-- <label class="form-control-label px-3">Kecamatan<span class="text-danger"> *</span></label>  --}}
                                <input type="text" id="kecamatan" name="kecamatan" placeholder="Kecamatan" onblur="validate(5)">
                            </div>
                            <div class="form-group col-sm-6 flex-column d-flex ">
                                {{-- <label class="form-control-label px-3">Desa/Kelurahan<span class="text-danger"> *</span></label>  --}}
                                <input type="text" id="desa_kelurahan" name="desa_kelurahan" placeholder="Desa/Kelurahan" onblur="validate(5)">
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-between text-left">
                            ...
                            <div class="form-group col-sm-6 flex-column d-flex ">
                                ...
                                <input type="text" id="jurusan" name="jurusan" placeholder="" onblur="validate(5)">
                            </div>
                        </div>
