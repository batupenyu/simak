...
@section('content')
    ...
    <p><a href="{{ url('pegawai.create') }}"><i class="fa fa-plus btn btn-sm btn-warning mt-3"><b style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif"> Pegawai</b></i></a></p> <br>
